...
from utils import *
from models.resnets import resnet50dil
import torch
import torchvision
...
if __name__ == "__main__":
    ...
    model_dir = os.path.join(model_dir, f'resnet50dil', 'pairsplits')
    print(model_dir)
    ...
    save_path = os.path.join(
            save_dir,
            f'resnet50dil_v{len(os.listdir(save_dir))}.pth.tar')
    for j in range(models_per_run):
        model = resnet50dil(num_classes=out_dim).cuda().train()
